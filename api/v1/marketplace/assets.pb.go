...
type AssetResponse struct {
	...
	Status               AssetStatus        `protobuf:"varint,3,opt,name=status,proto3,enum=marketplace.api.v1.marketplace.AssetStatus" json:"status,omitempty"`
	...
	PreviewUrl           *types.StringValue `protobuf:"bytes,5,opt,name=preview_url,json=previewUrl,proto3" json:"preview_url,omitempty"`
	EncryptedUrl         *types.StringValue `protobuf:"bytes,6,opt,name=encrypted_url,json=encryptedUrl,proto3" json:"encrypted_url,omitempty"`
	YtVideoId            *types.StringValue `protobuf:"bytes,7,opt,name=yt_video_id,json=ytVideoId,proto3" json:"yt_video_id,omitempty"`
...
func (m *AssetResponse) GetPreviewUrl() *types.StringValue {
	if m != nil {
		return m.PreviewUrl
	}
	return nil
...
func (m *AssetResponse) GetEncryptedUrl() *types.StringValue {
	if m != nil {
...
func (m *AssetResponse) GetYtVideoId() *types.StringValue {
	if m != nil {
		return m.YtVideoId
	}
	return nil
...
var fileDescriptor_028828bf06032c3b = []byte{
	...
	,
}
...
func (m *AssetResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ThumbnailUrl != nil {
		...
		n1, err1 := m.ThumbnailUrl.MarshalTo(dAtA[i:])
		if err1 != nil {
			return 0, err1
		}
		i += n1
	...
	if m.PreviewUrl != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintAssets(dAtA, i, uint64(m.PreviewUrl.Size()))
		n2, err2 := m.PreviewUrl.MarshalTo(dAtA[i:])
		if err2 != nil {
			return 0, err2
		}
		i += n2
	...
	if m.EncryptedUrl != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintAssets(dAtA, i, uint64(m.EncryptedUrl.Size()))
		n3, err3 := m.EncryptedUrl.MarshalTo(dAtA[i:])
		if err3 != nil {
			return 0, err3
		}
		i += n3
	...
	if m.YtVideoId != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintAssets(dAtA, i, uint64(m.YtVideoId.Size()))
		n4, err4 := m.YtVideoId.MarshalTo(dAtA[i:])
		if err4 != nil {
			return 0, err4
		}
		i += n4
...
func (m *AssetResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.PreviewUrl == nil {
				m.PreviewUrl = &types.StringValue{}
			}
		...
		case 6:
			...
			if m.EncryptedUrl == nil {
				m.EncryptedUrl = &types.StringValue{}
			}
			if err := m.EncryptedUrl.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field YtVideoId", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.YtVideoId == nil {
				m.YtVideoId = &types.StringValue{}
			}
			if err := m.YtVideoId.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
